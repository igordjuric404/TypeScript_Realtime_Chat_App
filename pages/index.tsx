...
export default function Home() {
  return (
    <main>
      <header className='flex gap-4 py-2 px-4 items-center border-b border-gray-100'>
        ...
        <div className='ml-auto flex items-center gap-3 bg-gray-100 py-2 px-3 rounded-2xl'>
          <div className='light-mode'>
            <svg
              className='h-8 w-8 fill-gray-900 rounded-full bg-yellow-300 p-2'
              viewBox='0 0 20 20'
            >
          ...
          <div className='dark-mode'>
            <svg
              className='h-8 w-8 fill-white rounded-full bg-purple-400 p-2'
              viewBox='0 0 20 20'
            >
